import oneParameter from '@cea/f/src/curry/oneParameter'
import twoParameters from '@cea/f/src/curry/twoParameters'
import threeParameters from './threeParameters'
import __, { isGap } from '@cea/f/src/gap'

jest.mock('@cea/f/src/curry/oneParameter')
jest.mock('@cea/f/src/curry/twoParameters')
jest.mock('@cea/f/src/gap')
